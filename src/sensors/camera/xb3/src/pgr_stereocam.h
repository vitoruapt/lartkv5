/**
 * @defgroup pgr Point Grey libdcstereo library
 * @file
 * @brief Library from Point Grey Research to access the xb3 images.
 * @ingroup xb3
 *@{
 */


#ifndef PGR_STEREOCAM_H_
#define PGR_STEREOCAM_H_
...
//#include "/usr/local/include/dc1394/control.h"
//#include "/usr/local/include/dc1394/control.h"
...
//
// Input:
//  stereoaAmera - The camera to grab from  
//
// Description:
...
//  pucRGB           - a buffer to hold the RGB images
//                     size is (nrows * ncols * nimages * 3)
//                     allocated outside this function
//  pucGreen         - a buffer to hold the green channels of the images
//                     size is (nrows * ncols * nimages)
//                     allocated outside this function
