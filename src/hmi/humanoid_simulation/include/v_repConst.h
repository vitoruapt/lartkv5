...
enum {	simros_strmcmdnull_start				=0,
		...
		simros_strmcmd_get_imu1_data, /* Added by João O. Barros on 22/12/2014; */
		simros_strmcmd_get_imu2_data,
		simros_strmcmd_get_imu3_data,
		simros_strmcmd_get_imu4_data,
		simros_strmcmd_get_imu5_data,
		simros_strmcmd_get_imu6_data,
		simros_strmcmd_get_imu7_data,
		simros_strmcmd_get_imu8_data,
		simros_strmcmd_get_imu9_data,
