...
//	simRegisterCustomLuaVariable("simros_strmcmd_get_joint_force",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_joint_force))).c_str());
	...
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu1_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu1_data))).c_str()); /* Added by João O. Barros on 22/12/2014; */  
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu2_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu2_data))).c_str());
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu3_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu3_data))).c_str());
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu4_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu4_data))).c_str());
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu5_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu5_data))).c_str());
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu6_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu6_data))).c_str());
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu7_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu7_data))).c_str());
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu8_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu8_data))).c_str());
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu9_data",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu9_data))).c_str());
